      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl font-bold">Bafana</span>
            </div>
            <p className="text-neutral-400 leading-relaxed mb-6">
              Every act, Bafana is your trusted partner in sustainable animal agriculture, 
              helping farmers and ranchers build a better future through innovation and expertise.
            </p>
            {/* Social Links */}
        ...
        <div className="border-t border-neutral-800 pt-12 mb-12">
          <div className="max-w-2xl">
            ...
            <p className="text-neutral-400 mb-6">
              Get the latest updates on sustainable agriculture practices and industry insights.
            </p>
        ...
        <div className="border-t border-neutral-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-neutral-400 text-sm text-center md:text-left">
            © {currentYear} Bafana Agricultural Solutions. All rights reserved.
          </p>
          <div className="flex items-center gap-6 text-sm text-neutral-400">
            <a href="#" className="hover:text-brand-400 transition-colors duration-300">
              Privacy
            </a>
            <a href="#" className="hover:text-brand-400 transition-colors duration-300">
              Terms
